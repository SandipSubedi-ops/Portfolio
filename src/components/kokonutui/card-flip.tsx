...
export interface CardFlipProps {
  ...
  features?: string[];
  bottomTitle?: string;
  popupContent?: React.ReactNode; // ✅ New prop
}
...
export default function CardFlip({
  ...
  return (
    <div className="relative">
      <div
        className="w-full max-w-[280px] h-[320px] group [perspective:2000px] relative z-10"
      ...
      >
        ...
        >
          ...
          >
            <div className="h-full overflow-hidden bg-gradient-to-b from-zinc-100 to-white dark:from-zinc-900 dark:to-black">
              <div className="inset-0 flex items-start justify-center pt-24">
                  ...
                  <DialogTrigger asChild>
                    <div
                      className={cn(
                        ...
                        "p-3 -m-3 rounded-xl transition-all duration-300",
                        ...
                        "dark:hover:from-orange-500/20 dark:hover:via-orange-500/10",
