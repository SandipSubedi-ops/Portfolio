      ...
      <div className="flex gap-20 whitespace-nowrap animate-infinite-scroll">
        <div className="flex items-center gap-20">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="dark:text-white text-lg font-medium">.Net</div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="dark:text-white text-lg font-medium">Database</div>
          </div>
        </div>

        <div
          className="flex items-center gap-20 justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none"
          aria-hidden="true"
        >
          <div className="flex items-center gap-2">
            <svg
